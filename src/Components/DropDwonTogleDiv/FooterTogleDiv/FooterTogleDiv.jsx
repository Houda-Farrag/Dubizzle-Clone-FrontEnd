        ...
        <div>
            <div className=''>
                <div aria-label="footer" className="pt-2 px-3">
                    <button
                        onClick={() => { }}
                        type="button"
                        class="text-white font-bold bg-red-600 flex items-center justify-center space-x-3 py-3 px-4 w-full leading-6 text-lg rounded-md"
                    >
                        Log in
                    </button>
                </div>
            ...
            <div className='hidden'>
                <div aria-label="footer" className="pt-2 px-2">
                    <nav class="grid grid-flow-col gap-1  justify-start text-xl">
