    ...
    return (
        <div className={(false) ? "hidden" : "block  top-0 min-h-screen "}>
            ...
            <div class="flex  justify-center  bg-gray-100 ">
                <div
                    class="w-full max-w-full rounded-lg bg-white   divide-y divide-gray-200">
                    <div>
