            ...
            <ul>
              ...
              <li
                className={`flex items-center py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 cursor-pointer ${
                  selectedMenuItem === "Vehicles" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Properties" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Mobile & tablets" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Jobs" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Furniture & Decor" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Pets" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Kids & babies" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Hoppies" && "bg-gray-50"
                }`}
              ...
              <li
                className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                  selectedMenuItem === "Fashion & Beauty" && "bg-gray-50"
                }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Cars for sale" && "bg-gray-50"
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Cars for Rent" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Cars Spare Parts" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Boats - Watercraft" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Tyres , Oils & Accessories" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Apartments for Sale" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Apartments for Rent" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Villas For Sale" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Villas For Rent" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Vacation Homes for Sale" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Vacation Homes for Rent" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Commercial for Sale" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Commercial for Rent Buildings & Lands" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Buildings & Lands" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Mobile Phones" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Tablets" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Mobile & Tablet Accessories Mobile Numbers" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Mobile Numbers" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Accounting, Finance & Banking" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Engineering" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Designers" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Customer Service & Call Center" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Workers and Technicians" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Management & Consulting" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Drivers & Delivery" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Education" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "HR" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Tourism, Travel & Hospitality" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "IT - Telecom" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Marketing and Public Relations" && "bg-gray-50"
                    }`}
          ...
          {selectedMenuItem == "Electronics & Appliances" && (
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <li
                  className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                    selectedSubMenu1 == "TV Audio Video" && "bg-gray-50"
                  }`}
                ...
                <li
                  className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                    selectedSubMenu1 === "Cameras - Imaging" && "bg-gray-50"
                  }`}
                ...
                <li
                  className={`flex items-center cursor-pointer justify-between py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                    selectedSubMenu1 === "Home Appliances" && "bg-gray-50"
                  }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Bathroom" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Bedroom" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Dining Room" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Fabrics - Curtains - Carpets" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Garden - Outdoor" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Home Decoration" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Kitchen - Kitchenware" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Lighting Tools" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Living Room" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Multiple/Other Furniture" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Birds - Pigeons" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Cats" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Dogs" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Other Pets & Animals" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Accessories - Pet Care Products" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Baby & Mom Healthcare" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Baby Clothing" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Baby Feeding Tools" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Cribs - Strollers - Carriers" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Toys" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Other Baby Items" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Antiques - Collectibles" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Bicycles" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Books" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Board - Card Games" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Movies - Music" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Musical Instruments" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Sports Equipment" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Study Tools" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Tickets - Vouchers" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Luggage" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Other Items" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Women`s Clothing" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Men`s Clothing" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Women`s Accessories - Cosmetics - Personal Care" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu1 === "Men`s Accessories - Personal Care" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Televisions" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "DVD - Home Theater" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Home Audio" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50${
                      selectedSubMenu2 === "Mp3 Players - Portable audio" &&
                      "bg-gray-50"
                    }`}
                    onClick={() =>
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Satellite TV receivers" &&
                      "bg-gray-50"
                    }`}
                    onClick={() =>
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Desktop computers" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Laptop computers" && "bg-gray-50"
                    }`}
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Video Game Consoles" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Video Games & Accessories" &&
                      "bg-gray-50"
                    }`}
                    onClick={() =>
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Cameras" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Security Cameras" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg bg-gray-50 ${
                      selectedSubMenu2 === "Camera Accessories" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Binoculars - Telescopes" &&
                      "bg-gray-50"
                    }`}
                    onClick={() =>
            ...
            <div className="bg-white">
              <ul className="mt-14">
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Refrigerators - Freezers" &&
                      "bg-gray-50"
                    }`}
                    onClick={() =>
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Ovens - Microwaves" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Dishwashers" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Cooking Tools" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Washers - Dryers" && "bg-gray-50"
                    }`}
                    bg-gray-50
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Water Coolers & Kettles" &&
                      "bg-gray-50"
                    }`}
                    onClick={() =>
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Air conditioners & Fans" &&
                      "bg-gray-50"
                    }`}
                    onClick={() =>
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Cleaning Appliances" && "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Other Home Appliances" &&
                      "bg-gray-50"
                    }`}
                ...
                <Link to={"/sellform"}>
                  <li
                    className={`py-2 px-4 my-1 text-black rounded-lg hover:bg-gray-50 ${
                      selectedSubMenu2 === "Heaters" && "bg-gray-50"
                    }`}
