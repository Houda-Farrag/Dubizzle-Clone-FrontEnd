...
export default function TopHeader() {
    ...
    let [CheckTogle, setCheckTogle] = useState(true)

    const navigate = useNavigate();

    const togleNavigate = (CheckTogle_) => {
        (CheckTogle_) ? navigate("/togle") : navigate("/")
    }

    return (
        <div className="sm:border-none border-b-0">
            <div className="md:container mx-2  flex justify-start ">
                <button
                    className="text-3xl me-2 md:hidden visible text-red-600"
                    onClick={() => {
                        setCheckTogle(!CheckTogle)
                        togleNavigate(CheckTogle)

                        console.log(CheckTogle)
                ...
                <a href="/">
                    <svg fill="none" viewBox="0 0 64 35" alt="Logo" width={82}>
                ...
                <div className="flex ">
                    <button
                        ...
                        className=" grid grid-flow-col items-center text-black"
                    >
                        <span
                            className="text-x flex  mx-3" style={{ borderRadius: "80%", background: "#fef5f5" }}>
                            <img className="rounded-2xl p-2" width={"40px"} height={"40px"} src="https://www.dubizzle.com.eg/assets/property-for-rent_noinline.afd1b8bf81720cc538aba324a684f145.svg" alt="" />
                        </span>
                        <span className=" hover:underline">
                            <p className="text-black font-bold">  Properties</p>
                        </span>
                    </button>
                </div>
            </div>
