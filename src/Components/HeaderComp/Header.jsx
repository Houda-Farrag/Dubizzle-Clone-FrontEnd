          ...
          <div className="flex justify-start">
            <a href="#">
              ...
              >
                ...
                <defs>
                  <clipPath id="a">
                    <path fill="#fff" d="M0 0h64v20.13H0z"></path>
                  </clipPath>
                </defs>
              </svg>
            </a>
              ...
              <div className=" grid grid-flow-col ">
                ...
                <div className="relative">
                  <div className="grid grid-flow-col item-center col-span-3">
                    {!facebook && !google ? (
                      <Login google={google} facebook={facebook} login={login} setFacebook={setFacebook} setGoogle={setGoogle} setEmail={setEmail} />
                    ) : (
                      <DropDownList
                ...
                <button
                  ...
                  className="col-span-5 h-14 border bg-red-500 hover:bg-red-600 rounded-lg text-white font-bold"
                >
                  Sell
                </button>
              </div>
