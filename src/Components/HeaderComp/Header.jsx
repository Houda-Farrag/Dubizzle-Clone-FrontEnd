        ...
        <div className='my-2' >
          <div className='grid   grid-flow-col gap-1'>
            ...
            <div className='flex col-span-2'>
              <input type="text" className='h-14 w-full border rounded-xl rounded-e-none ' />
              <button className='bg-red-500 p-4 h-14 rounded-e-lg '><IoSearchSharp /></button>
            </div>

            <div className=' grid grid-flow-col '>
              <div className='grid h-14 font-bold text-xl text-center items-center '>
                <button>English</button>
              </div>
              <div className=' text-center'>
                <button  onClick={()=>{navigate(`/chat`)}}    className=' text-center '>
