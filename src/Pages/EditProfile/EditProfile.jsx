...
function EditProfile() {
  ...
  // const [selectGender,setSelectGender] = useState(updateUser.gender)
  //    const handleSelect = (selectValue)=>{
  //     setSelectGender(selectValue)
  //    }
    // const divide =()=>{
    //   const arr = updateUser.dateOfBirth.split("-")
    // const day = arr[0]
    // const month = arr[1]
    // const year = arr[2]
  ...
  return (<>
    <div className="w-vw-70/100 flex mx-auto mb-12 mt-5 py-4 px-6 rounded-md border border-gray-300">
      <form onSubmit={handleSubmit(submitData)}>
          ...
          <div className="w-1/2">
            ...
            <div className='flex flex-col mt-4'>
              ...
              <div className='flex w-full justify-between gap-2'>
                <select name='day'  {...register("day")} className="text-md w-1/3  px-3 py-3 rounded-lg border flex justify-between">
                ...
                <select name='month'   {...register("month")} className="text-md w-1/3 px-3 py-3 rounded-lg border flex justify-between">
                ...
                <select name='year'  {...register("year")} className="text-md w-1/3 px-3 py-3 rounded-lg border flex justify-between">
            ...
            <div className='flex flex-col mt-4'>
              ...
              <select name='gender' {...register("gender")} defaultValue={updateUser.gender} className="text-md  px-3 py-3 rounded-lg border flex justify-between">
            ...
            <div className='mt-5'>
              <textarea name='about' rows={7} {...register("about")} defaultValue={updateUser.about} className='p-2  w-full border outline-none rounded-md'></textarea>
            </div>
          </div>
        ...
        <div className='Contact pb-10 border-b border-gray-200'>
